  ...
  connectedCallback() {
    this.innerHTML = `
      <section class="invitation">
        <h1 class="invitation__title">Хотите научиться<br> web-разработке?</h1>
        <p class="invitation__welcome-text">Приглашаем Вас<br> на бесплатный вебинар «Тренды Frontend-разработки 2020»</p>
